...
// class BluPrintPage extends StatefulWidget {
//   const BluPrintPage({super.key});

//   @override
//   State<BluPrintPage> createState() => _BluPrintPageState();
// }

// class _BluPrintPageState extends State<BluPrintPage> {
...
class _TextingState extends State<Texting> {
  ...
  void initState() {
    super.initState();
    // Initialize the selectedRadio to -1 (no radio button selected)
    selectedRadio = -1;
  }
  @override
  Widget build(BuildContext context) {
